		...
		return BaseController.extend("au.com.bournedigital.developertest.controller.Object", {
			...
			onInit : function () {
				...
				var iOriginalBusyDelay,
					oViewModel = new JSONModel({
						...
						delay : 0,
						totalOrderAmount: 0,
						objectViewLineItemTableNoDataText:this.getResourceBundle().getText("objectViewLineItemTableNoDataText"),
						lineItemListTitle:this.getResourceBundle().getText("lineItemListTitle")
					});
			...
			onListUpdateFinished : function (oEvent) {
				...
				if (oItemsBinding.isLengthFinal()) {
					...
					fOrderTotal = aItemsContext.reduce(this._calculateOrderTotal, 0);
			...
			/* Total Calculation */
			_calculateOrderTotal: function (fPreviousTotal, oCurrentContext) {
			var fItemTotal = oCurrentContext.getObject().Quantity * oCurrentContext.getObject().UnitPrice;
				fItemTotal = fItemTotal - (fItemTotal * oCurrentContext.getObject().Discount);
