sap.ui.define([
		...
		return BaseController.extend("au.com.bournedigital.developertest.controller.Worklist", {
			...
			onSearch : function (oEvent) {
				if (oEvent.getParameters().refreshButtonPressed) {
					...
					this._applySearch(aTableSearchState);
						...
						this._applySearch(fTableFilters);	
					}
				}
			...
			//For QuickView Display			
			onQuickView : function (oEvent) {
				var oModel = this.getView().getModel('worklistView').getProperty("/employeeInfo");
				var employeeInfo = oEvent.getSource().getBindingContext().getObject('Employee');
				oModel.setData(employeeInfo);
			...
			//Internal helper method for Quick View
